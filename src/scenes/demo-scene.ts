...
export class DemoScene extends Phaser.Scene {
    ...
    async #addGamePiece(row: number, col: number, player: Player): Promise<void> {
    ...
    async #createMockGame(): Promise<void> {
        ...
        for (const move of movesToMake) {
            ...
            const nextPlayerAssetKey = currentPlayer === Player.ONE ? GAME_ASSETS.RED_PIECE : GAME_ASSETS.YELLOW_PIECE;
            this.#gamePiece
            ...
            await this.#addGamePiece(coordinate.y, coordinate.x, currentPlayer);
